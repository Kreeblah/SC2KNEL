...
Partial Class UpdateMessageBox
    ...
    Private Sub InitializeComponent()
        ...
        Me.textbox.Text = "                 There is a new update available for SimCity 2000 Network Edition" & _
    ". " & Global.Microsoft.VisualBasic.ChrW(10) & " Press yes to download the latest patch, or press no to continue. Details are" & _
    " listed below:" & Global.Microsoft.VisualBasic.ChrW(10) & Global.Microsoft.VisualBasic.ChrW(10)
        '
        'no
        '
